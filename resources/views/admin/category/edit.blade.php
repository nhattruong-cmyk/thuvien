...
@section('titlepage', 'Cập nhật danh mục')
            ...
            <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                ...
                <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                    ...
                    <ul class="breadcrumb fw-bold fs-base my-1">
                        ...
                        <li class="breadcrumb-item text-dark">Cập nhật danh mục</li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                <!--end::Page title=-->
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header mt-6">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{ route('admin.category.listCate') }}"><input type="button" value="Danh sách danh mục"
                    ...
                    <div class="card-body pt-0">
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            <form class="form" action="{{ route('admin.category.updateCate') }}" method="post"
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                                    ...
                                    <div class="fv-row mb-7">
                                        <label class="required fw-bold fs-6 mb-2">Tên danh mục</label>
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid rounded-3" name="description" rows="4">{{ $category->description }}</textarea>
                                        @error('description')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
