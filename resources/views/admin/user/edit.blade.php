...
@section('titlepage', 'Cập nhật tài khoản')
            ...
            <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                ...
                <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                    ...
                    <ul class="breadcrumb fw-bold fs-base my-1">
                        ...
                        <li class="breadcrumb-item text-dark">Cập nhật tài khoản</li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                <!--end::Page title=-->
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="w-50 pe-3">
                                        <div class="fv-row mb-7">
                                            <label class="required fw-bold fs-6 mb-2">Tên tài khoản</label>
                                            <input type="text" name="name" class="form-control form-control-solid" placeholder="Tên tài khoản" value="{{ old('name', $user->name) }}" />
                                            @error('name')
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="password" name="password" class="form-control form-control-solid" placeholder="Mật khẩu" value="{{ old('password', $user->password) }}" />
                                            @error('password')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="w-50 ps-3">
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <select name="role_id" class="form-control form-control-solid mb-3 mb-lg-0">
                                                <option value="0" selected>Vui lòng chọn phân quyền</option>
