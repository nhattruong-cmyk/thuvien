                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header mt-6">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{ route('productlist') }}"><input type="button" value="Danh sách sản phẩm"
                    ...
                    <div class="card-body pt-0">
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            <form class="form" action="{{ route('productadd') }}" method="post"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: url( {{ asset('public/img/product/product1/8.3_56fec49dcbb146459a56fd6c77f85b02_master.jpg') }});">
                                            </div>
