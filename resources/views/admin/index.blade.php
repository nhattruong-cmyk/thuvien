                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
                            ...
                            <a href="{{ route('admin') }}" class="d-flex align-items-center">
                                ...
                                <img alt="Logo" src="{{ asset('public/img/home/logo-no-background.png') }}"
                                    class="h-30px" />
                                ...
                                <div class="card card-xxl-stretch mb-xl-8">
                                    ...
                                    <div class="card-body pt-5">
                                        ...
                                        <div class="d-flex mb-7">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
                                                <img src="{{ asset('assets/media/stock/600x400/img-4.jpg') }}"
                                                    class="mw-100" alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Section-->
                                        ...
                                        <div class="d-flex mb-7">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
                                                <img src="{{ asset('assets/media/stock/600x400/img-5.jpg') }}"
                                                    class="mw-100" alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Section-->
                                        ...
                                        <div class="d-flex mb-7">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
                                                <img src="{{ asset('assets/media/stock/600x400/img-6.jpg') }}"
                                                    class="mw-100" alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Section-->
                                        ...
                                        <div class="d-flex">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
                                                <img src="{{ asset('assets/media/stock/600x400/img-7.jpg') }}"
                                                    class="mw-100" alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Section-->
